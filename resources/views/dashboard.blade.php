...
<div class="container py-4">
    ...
    <form action="{{ route('dashboard') }}" method="GET" class="d-flex align-items-center gap-2">
        ...
        <input type="month" name="month" id="month" class="form-control form-control-sm" value="{{ $month }}" onchange="this.form.submit()">
    </form>
</div>
...
<div class="row g-4">
    ...
    {{-- Right Column: Recent Transaction Table --}}
    <div class="col-12 col-lg-6">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold text-dark">Recent Transaction</h6>
                        ...
                        <tbody>
                            @forelse ($recentTransactions as $tx)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge rounded-pill text-white px-2 py-1" style="background-color: {{ $tx->category->color ?? '#6c757d' }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted py-4">
                                        No recent transaction logged yet.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
